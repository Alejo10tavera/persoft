    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
            ...
            <div class="statbox widget box box-shadow">
                <button type="button" class="btn btn-outline-success btn-sm mb-2 mr-2" data-toggle="modal" data-target=".modal-add-lend">Agregar préstamo</button><hr>
                <div class="widget-content widget-content-area">
                    <table id="tableLends" class="table style-3 tableLends table-hover table-bordered table-striped dt-responsive" width="100%">
                        <thead>
                            <tr>
...
<div class="modal fade modal-add-lend" tabindex="-1" role="dialog" aria-labelledby="add-lend" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <form class="needs-validation" novalidate method="post">

                <div class="modal-header">
                    <h5 class="modal-title" id="add-lend">Agregar préstamo</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <?php 
                            ...
                            $createLend = new ControllerLends();
                            $createLend -> ctrCreateLend();
...
<div class="modal fade modal-edit-lend" tabindex="-1" role="dialog" aria-labelledby="edit-lend" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <form class="needs-validation" novalidate method="post">

                <div class="modal-header">
                    <h5 class="modal-title" id="edit-lend">Editar deuda</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <?php 
                            ...
                            $editLend = new ControllerLends();
                            $editLend -> ctrEditLend();
